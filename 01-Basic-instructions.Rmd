...
1. Go to [the repo](https://github.com/warhornmedia/warhorn-classics-book-template) on Github and click "Use this template." (You must be logged into Github already.)
